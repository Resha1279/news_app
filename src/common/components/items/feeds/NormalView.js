...
class NormalView extends React.Component {
    ...
    render() {
        const {item, index, onClick, hideViews, showCategory,onCategoryClicked} = this.props;
            ...
            >
                <View style={styles.feedsCardContent}>
                    ...
                    <View style={styles.userInteractionInfo}>
                        {showCategory ?
                            <ProtoTouchable style={{padding: 10, paddingLeft: 0}} onPress={onCategoryClicked}>
                                <ProtoText
                                    style={[
                                        globalStyles.tertiaryText,
                                        styles.category
...
export default connect(null,
    {
        ...
        play,
        pause
    })(connectLocalization(NormalView));
