...
Readability.prototype = {
  ...
  **/
  ...
  _getArticleTitle: function() {
    ...
    try {
      ...
      if (!__DEV__){
          console.log("Title from title tag : ", curTitle);
      }
  ...
  **/
  _grabArticle: function (page) {
    ...
    if (!__DEV__){
      console.log("readability : page : ", page);
    }
  ...
  **/
  ...
  parse: function () {
    ...
    this._prepDocument();
      ...
      if (!__DEV__){
          console.log("article : after prepDocument : ", this._doc);
      }

    var metadata = this._getArticleMetadata();
      if (!__DEV__){
          console.log("article : meta data : ", metadata);
      }
