...
class IntroPagerItemTwo extends React.Component {
    render() {
            ...
            <View style={{flex: 1}}>
                <ImageBackground source={{uri: 'intro_bg'}} style={styles.background}>
                    <View
                        ...
                        {this.renderInfo('data_usage', 'Data Usage', subLabel)}
                        {this.renderInfo('offline_mode', 'OfflineMode', subLabel)}
                        {this.renderInfo('material_ui', 'Material UI', subLabel)}
                    </View>
                    <View
                        style={{
                            justifyContent: 'center',
...
export default connectLocalization(IntroPagerItemTwo)
