                ...
                <ImageBackground source={{uri: 'intro_bg'}} style={styles.background}>
                    <View
                        ...
                        <ProtoText style={[globalStyles.primaryText, {
                            ...
                            Listen to your favourite news
                        </ProtoText>
                        <ProtoText
                            style={[globalStyles.secondaryText, {lineHeight: 18, textAlign: 'center', width: '70%'}]}>
                            We enhanced text to speech feature of your device to read the news for you.
                        </ProtoText>
                    </View>
                    <View
                        style={{
